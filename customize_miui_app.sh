...
if [ $1 = "ContactsProvider" ];then
    # fix ContactsProvider t9 translated from KDGDev
    for file5 in ContactsProvider/smali/com/android/providers/contacts/t9/*
    do
        cp -f $file5 out/ContactsProvider/smali/com/android/providers/contacts/t9
    done
fi
